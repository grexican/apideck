...
namespace Apideck.Accounting.Api
{
    ...
    /// </summary>
    public interface ICompanyInfoApiSync : IApiAccessor
    {
        ...
        GetCompanyInfoResponse CompanyInfoOne(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string));
        ...
        ApiResponse<GetCompanyInfoResponse> CompanyInfoOneWithHttpInfo(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICompanyInfoApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetCompanyInfoResponse> CompanyInfoOneAsync(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetCompanyInfoResponse>> CompanyInfoOneWithHttpInfoAsync(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICompanyInfoApi : ICompanyInfoApiSync, ICompanyInfoApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CompanyInfoApi : ICompanyInfoApi
    {
        private Apideck.Accounting.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyInfoApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CompanyInfoApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CompanyInfoApi(string basePath)
        {
        ...
        /// <returns></returns>
        public CompanyInfoApi(Apideck.Accounting.Client.Configuration configuration)
        {
        ...
        public CompanyInfoApi(Apideck.Accounting.Client.ISynchronousClient client, Apideck.Accounting.Client.IAsynchronousClient asyncClient, Apideck.Accounting.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="xApideckServiceId">Provide the service id you want to call (e.g., pipedrive). [See the full list in the connector section.](#section/Connectors) Only needed when a consumer has activated multiple integrations for a Unified API. (optional)</param>
        /// <returns>GetCompanyInfoResponse</returns>
        public GetCompanyInfoResponse CompanyInfoOne(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string))
        {
            Apideck.Accounting.Client.ApiResponse<GetCompanyInfoResponse> localVarResponse = CompanyInfoOneWithHttpInfo(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId);
        ...
        /// <param name="xApideckServiceId">Provide the service id you want to call (e.g., pipedrive). [See the full list in the connector section.](#section/Connectors) Only needed when a consumer has activated multiple integrations for a Unified API. (optional)</param>
        /// <returns>ApiResponse of GetCompanyInfoResponse</returns>
        public Apideck.Accounting.Client.ApiResponse<GetCompanyInfoResponse> CompanyInfoOneWithHttpInfo(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string))
        {
            // verify the required parameter 'xApideckConsumerId' is set
            if (xApideckConsumerId == null)
            {
                throw new Apideck.Accounting.Client.ApiException(400, "Missing required parameter 'xApideckConsumerId' when calling CompanyInfoApi->CompanyInfoOne");
            }

            // verify the required parameter 'xApideckAppId' is set
            if (xApideckAppId == null)
            {
                throw new Apideck.Accounting.Client.ApiException(400, "Missing required parameter 'xApideckAppId' when calling CompanyInfoApi->CompanyInfoOne");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetCompanyInfoResponse</returns>
        public async System.Threading.Tasks.Task<GetCompanyInfoResponse> CompanyInfoOneAsync(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Apideck.Accounting.Client.ApiResponse<GetCompanyInfoResponse> localVarResponse = await CompanyInfoOneWithHttpInfoAsync(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetCompanyInfoResponse)</returns>
        public async System.Threading.Tasks.Task<Apideck.Accounting.Client.ApiResponse<GetCompanyInfoResponse>> CompanyInfoOneWithHttpInfoAsync(string xApideckConsumerId, string xApideckAppId, bool? raw = default(bool?), string xApideckServiceId = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xApideckConsumerId' is set
            if (xApideckConsumerId == null)
            {
