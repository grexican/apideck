...
namespace Apideck.Accounting.Model
{
    ...
    public partial class CompanyInfo : IEquatable<CompanyInfo>, IValidatableObject
    {
        ...
        public CompanyInfo(string companyName = default(string), string salesTaxNumber = default(string), Currency? currency = default(Currency?), List<Address> addresses = default(List<Address>), List<PhoneNumber> phoneNumbers = default(List<PhoneNumber>), List<Email> emails = default(List<Email>))
        {
