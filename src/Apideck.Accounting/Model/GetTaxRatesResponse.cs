...
namespace Apideck.Accounting.Model
{
    ...
    /// GetTaxRatesResponse
    /// </summary>
    [DataContract(Name = "GetTaxRatesResponse")]
    public partial class GetTaxRatesResponse : IEquatable<GetTaxRatesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTaxRatesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTaxRatesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTaxRatesResponse" /> class.
        /// </summary>
        ...
        public GetTaxRatesResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<TaxRate> data = default(List<TaxRate>), Meta meta = default(Meta), Links links = default(Links))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetTaxRatesResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetTaxRatesResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetTaxRatesResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetTaxRatesResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetTaxRatesResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
        ...
        {
            return this.Equals(input as GetTaxRatesResponse);
        }

        /// <summary>
        /// Returns true if GetTaxRatesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTaxRatesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTaxRatesResponse input)
        {
            if (input == null)
            {
                return false;
