...
namespace Apideck.Accounting.Model
{
    ...
    public partial class LinkedLedgerAccount : IEquatable<LinkedLedgerAccount>, IValidatableObject
    {
        ...
        protected LinkedLedgerAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkedLedgerAccount" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="nominalCode">nominalCode.</param>
        public LinkedLedgerAccount(string id = default(string), string nominalCode = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for LinkedLedgerAccount and cannot be null");
            }
            this.Id = id;
