...
namespace Apideck.Accounting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetInvoiceItemsResponse")]
    public partial class GetInvoiceItemsResponse : IEquatable<GetInvoiceItemsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvoiceItemsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetInvoiceItemsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvoiceItemsResponse" /> class.
        /// </summary>
        ...
        public GetInvoiceItemsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<InvoiceItem> data = default(List<InvoiceItem>), Meta meta = default(Meta), Links links = default(Links))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetInvoiceItemsResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetInvoiceItemsResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetInvoiceItemsResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetInvoiceItemsResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetInvoiceItemsResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
        ...
        {
            return this.Equals(input as GetInvoiceItemsResponse);
        }

        /// <summary>
        /// Returns true if GetInvoiceItemsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetInvoiceItemsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetInvoiceItemsResponse input)
        {
            if (input == null)
            {
                return false;
