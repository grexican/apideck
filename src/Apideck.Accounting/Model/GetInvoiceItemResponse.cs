...
namespace Apideck.Accounting.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetInvoiceItemResponse")]
    public partial class GetInvoiceItemResponse : IEquatable<GetInvoiceItemResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvoiceItemResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetInvoiceItemResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetInvoiceItemResponse" /> class.
        /// </summary>
        ...
        public GetInvoiceItemResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), InvoiceItem data = default(InvoiceItem))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetInvoiceItemResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetInvoiceItemResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetInvoiceItemResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetInvoiceItemResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetInvoiceItemResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as GetInvoiceItemResponse);
        }

        /// <summary>
        /// Returns true if GetInvoiceItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetInvoiceItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetInvoiceItemResponse input)
        {
            if (input == null)
            {
                return false;
