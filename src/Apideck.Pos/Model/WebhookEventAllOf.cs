...
namespace Apideck.Pos.Model
{
    ...
    /// WebhookEventAllOf
    /// </summary>
    [DataContract(Name = "WebhookEvent_allOf")]
    public partial class WebhookEventAllOf : IEquatable<WebhookEventAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventAllOf" /> class.
        /// </summary>
        ...
        public WebhookEventAllOf(string eventId = default(string), string serviceId = default(string), string entityId = default(string), string entityType = default(string), string entityUrl = default(string), decimal executionAttempt = default(decimal), string occurredAt = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookEventAllOf {\n");
        ...
        {
            return this.Equals(input as WebhookEventAllOf);
        }

        /// <summary>
        /// Returns true if WebhookEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookEventAllOf input)
        {
            if (input == null)
            {
                return false;
