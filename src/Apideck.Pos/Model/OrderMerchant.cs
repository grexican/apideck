...
namespace Apideck.Pos.Model
{
    ...
    /// OrderMerchant
    /// </summary>
    [DataContract(Name = "Order_merchant")]
    public partial class OrderMerchant : IEquatable<OrderMerchant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderMerchant" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        public OrderMerchant(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as OrderMerchant);
        }

        /// <summary>
        /// Returns true if OrderMerchant instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderMerchant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderMerchant input)
        {
            if (input == null)
            {
                return false;
