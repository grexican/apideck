...
namespace Apideck.Pos.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Meta_cursors")]
    public partial class MetaCursors : IEquatable<MetaCursors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetaCursors" /> class.
        /// </summary>
        /// <param name="previous">Cursor to navigate to the previous page of results through the API.</param>
        /// <param name="current">Cursor to navigate to the current page of results through the API.</param>
        /// <param name="next">Cursor to navigate to the next page of results through the API.</param>
        public MetaCursors(string previous = default(string), string current = default(string), string next = default(string))
        {
        ...
        /// </summary>
        /// <value>Cursor to navigate to the previous page of results through the API</value>
        ...
        /// </summary>
        /// <value>Cursor to navigate to the current page of results through the API</value>
        ...
        /// </summary>
        /// <value>Cursor to navigate to the next page of results through the API</value>
        ...
        {
            return this.Equals(input as MetaCursors);
        }

        /// <summary>
        /// Returns true if MetaCursors instances are equal
        /// </summary>
        /// <param name="input">Instance of MetaCursors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetaCursors input)
        {
            if (input == null)
            {
                return false;
