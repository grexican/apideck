...
namespace Apideck.Pos.Model
{
    ...
    public partial class NotFoundResponse : IEquatable<NotFoundResponse>, IValidatableObject
    {
        ...
        public NotFoundResponse(decimal statusCode = default(decimal), string error = default(string), string typeName = default(string), string message = default(string), object detail = default(object), string _ref = default(string))
        {
