...
namespace Apideck.Pos.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnifiedId" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UnifiedId);
        }

        /// <summary>
        /// Returns true if UnifiedId instances are equal
        /// </summary>
        /// <param name="input">Instance of UnifiedId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnifiedId input)
        {
            if (input == null)
            {
                return false;
