...
namespace Apideck.Pos.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnprocessableResponse")]
    public partial class UnprocessableResponse : IEquatable<UnprocessableResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public UnprocessableResponse(decimal statusCode = default(decimal), string error = default(string), string typeName = default(string), string message = default(string), string detail = default(string), string _ref = default(string))
        {
        ...
        {
            return this.Equals(input as UnprocessableResponse);
        }

        /// <summary>
        /// Returns true if UnprocessableResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UnprocessableResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnprocessableResponse input)
        {
            if (input == null)
            {
                return false;
