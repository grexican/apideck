...
namespace Apideck.Pos.Model
{
    ...
    /// WebhookEventAllOf1
    /// </summary>
    [DataContract(Name = "WebhookEvent_allOf_1")]
    public partial class WebhookEventAllOf1 : IEquatable<WebhookEventAllOf1>, IValidatableObject
    {
        /// <summary>
        /// Defines EventType
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum Created for value: pos.order.created
            /// </summary>
            [EnumMember(Value = "pos.order.created")]
            Created = 1,

            /// <summary>
            /// Enum Updated for value: pos.order.updated
            /// </summary>
            [EnumMember(Value = "pos.order.updated")]
            Updated = 2,

            /// <summary>
            /// Enum Deleted for value: pos.order.deleted
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventAllOf1" /> class.
        /// </summary>
        /// <param name="eventType">eventType.</param>
        public WebhookEventAllOf1(EventTypeEnum? eventType = default(EventTypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookEventAllOf1 {\n");
        ...
        {
            return this.Equals(input as WebhookEventAllOf1);
        }

        /// <summary>
        /// Returns true if WebhookEventAllOf1 instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookEventAllOf1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookEventAllOf1 input)
        {
            if (input == null)
            {
                return false;
