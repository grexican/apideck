...
namespace Apideck.Pos.Model
{
    ...
    public partial class WebhookEvent : IEquatable<WebhookEvent>, IValidatableObject
    {
        ...
        public WebhookEvent(string eventId = default(string), string serviceId = default(string), string entityId = default(string), string entityType = default(string), string entityUrl = default(string), decimal executionAttempt = default(decimal), string occurredAt = default(string), EventTypeEnum? eventType = default(EventTypeEnum?))
        {
