...
namespace Apideck.Pos.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://unify.apideck.com";
        ...
        public Configuration(
            ...
            string basePath = "https://unify.apideck.com") : this()
        {
        ...
        {
            string report = "C# SDK (Apideck.Pos) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 8.11.0\n";
