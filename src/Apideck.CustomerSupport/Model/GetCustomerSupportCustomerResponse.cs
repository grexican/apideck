...
namespace Apideck.CustomerSupport.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCustomerSupportCustomerResponse")]
    public partial class GetCustomerSupportCustomerResponse : IEquatable<GetCustomerSupportCustomerResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerSupportCustomerResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetCustomerSupportCustomerResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerSupportCustomerResponse" /> class.
        /// </summary>
        ...
        public GetCustomerSupportCustomerResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), CustomerSupportCustomer data = default(CustomerSupportCustomer))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetCustomerSupportCustomerResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetCustomerSupportCustomerResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetCustomerSupportCustomerResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetCustomerSupportCustomerResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetCustomerSupportCustomerResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        public CustomerSupportCustomer Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCustomerSupportCustomerResponse {\n");
        ...
        {
            return this.Equals(input as GetCustomerSupportCustomerResponse);
        }

        /// <summary>
        /// Returns true if GetCustomerSupportCustomerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCustomerSupportCustomerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCustomerSupportCustomerResponse input)
        {
            if (input == null)
            {
                return false;
