...
namespace Apideck.CustomerSupport.Model
{
    ...
    public partial class BankAccount : IEquatable<BankAccount>, IValidatableObject
    {
        ...
        public BankAccount(string iban = default(string), string bic = default(string), string bsbNumber = default(string), string bankCode = default(string), string accountNumber = default(string), string accountName = default(string), AccountTypeEnum? accountType = default(AccountTypeEnum?), Currency? currency = default(Currency?))
        {
            this.Iban = iban;
            this.Bic = bic;
