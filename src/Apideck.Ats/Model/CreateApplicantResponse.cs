...
namespace Apideck.Ats.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateApplicantResponse")]
    public partial class CreateApplicantResponse : IEquatable<CreateApplicantResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateApplicantResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateApplicantResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateApplicantResponse" /> class.
        /// </summary>
        ...
        public CreateApplicantResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for CreateApplicantResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for CreateApplicantResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for CreateApplicantResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for CreateApplicantResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for CreateApplicantResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateApplicantResponse {\n");
        ...
        {
            return this.Equals(input as CreateApplicantResponse);
        }

        /// <summary>
        /// Returns true if CreateApplicantResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateApplicantResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateApplicantResponse input)
        {
            if (input == null)
            {
                return false;
