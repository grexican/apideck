...
namespace Apideck.Ats.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetApplicantsResponse")]
    public partial class GetApplicantsResponse : IEquatable<GetApplicantsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicantsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetApplicantsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicantsResponse" /> class.
        /// </summary>
        ...
        public GetApplicantsResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), List<Applicant> data = default(List<Applicant>), Meta meta = default(Meta), Links links = default(Links))
        {
            ...
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetApplicantsResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetApplicantsResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetApplicantsResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetApplicantsResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetApplicantsResponse);
        }

        /// <summary>
        /// Returns true if GetApplicantsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicantsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicantsResponse input)
        {
            if (input == null)
            {
                return false;
