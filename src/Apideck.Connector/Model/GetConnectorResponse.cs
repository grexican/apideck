...
namespace Apideck.Connector.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetConnectorResponse")]
    public partial class GetConnectorResponse : IEquatable<GetConnectorResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConnectorResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConnectorResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConnectorResponse" /> class.
        /// </summary>
        ...
        public GetConnectorResponse(int statusCode = default(int), string status = default(string), Connector data = default(Connector), Meta meta = default(Meta), Links links = default(Links))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetConnectorResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetConnectorResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
        ...
        {
            return this.Equals(input as GetConnectorResponse);
        }

        /// <summary>
        /// Returns true if GetConnectorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetConnectorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetConnectorResponse input)
        {
            if (input == null)
            {
                return false;
