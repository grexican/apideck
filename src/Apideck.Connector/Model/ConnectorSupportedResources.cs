...
namespace Apideck.Connector.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Connector_supported_resources")]
    public partial class ConnectorSupportedResources : IEquatable<ConnectorSupportedResources>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectorSupportedResources" /> class.
        /// </summary>
        ...
        public ConnectorSupportedResources(string id = default(string), string name = default(string), ResourceStatus? status = default(ResourceStatus?), string downstreamId = default(string), string downstreamName = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Status = status;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectorSupportedResources {\n");
        ...
        {
            return this.Equals(input as ConnectorSupportedResources);
        }

        /// <summary>
        /// Returns true if ConnectorSupportedResources instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectorSupportedResources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectorSupportedResources input)
        {
            if (input == null)
            {
                return false;
