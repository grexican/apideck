...
namespace Apideck.Connector.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetConnectorResourceResponse")]
    public partial class GetConnectorResourceResponse : IEquatable<GetConnectorResourceResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConnectorResourceResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConnectorResourceResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConnectorResourceResponse" /> class.
        /// </summary>
        ...
        public GetConnectorResourceResponse(int statusCode = default(int), string status = default(string), ConnectorResource data = default(ConnectorResource), Meta meta = default(Meta), Links links = default(Links))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetConnectorResourceResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetConnectorResourceResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
        ...
        {
            return this.Equals(input as GetConnectorResourceResponse);
        }

        /// <summary>
        /// Returns true if GetConnectorResourceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetConnectorResourceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetConnectorResourceResponse input)
        {
            if (input == null)
            {
                return false;
