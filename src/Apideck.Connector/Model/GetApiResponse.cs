...
namespace Apideck.Connector.Model
{
    ...
    /// GetApiResponse
    /// </summary>
    [DataContract(Name = "GetApiResponse")]
    public partial class GetApiResponse : IEquatable<GetApiResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApiResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetApiResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApiResponse" /> class.
        /// </summary>
        ...
        public GetApiResponse(int statusCode = default(int), string status = default(string), Api data = default(Api), Meta meta = default(Meta), Links links = default(Links))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetApiResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetApiResponse and cannot be null");
            }
            this.Data = data;
            this.Meta = meta;
            this.Links = links;
