...
namespace Apideck.Crm.Model
{
    ...
    public partial class UpdateNoteResponse : IEquatable<UpdateNoteResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateNoteResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateNoteResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateNoteResponse" /> class.
        /// </summary>
        ...
        public UpdateNoteResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for UpdateNoteResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for UpdateNoteResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for UpdateNoteResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for UpdateNoteResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for UpdateNoteResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as UpdateNoteResponse);
        }

        /// <summary>
        /// Returns true if UpdateNoteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateNoteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateNoteResponse input)
        {
            if (input == null)
            {
                return false;
