...
namespace Apideck.Crm.Model
{
    ...
    /// OpportunitiesSort
    /// </summary>
    [DataContract(Name = "OpportunitiesSort")]
    public partial class OpportunitiesSort : IEquatable<OpportunitiesSort>, IValidatableObject
    {
        /// <summary>
        /// The field on which to sort the Opportunities
        /// </summary>
        /// <value>The field on which to sort the Opportunities</value>
        ...
        public enum ByEnum
        {
            ...
            /// <summary>
            /// Enum WinProbability for value: win_probability
            /// </summary>
            [EnumMember(Value = "win_probability")]
            WinProbability = 4,

            /// <summary>
            /// Enum MonetaryAmount for value: monetary_amount
            /// </summary>
            [EnumMember(Value = "monetary_amount")]
            MonetaryAmount = 5,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpportunitiesSort" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OpportunitiesSort() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OpportunitiesSort" /> class.
        /// </summary>
        /// <param name="by">The field on which to sort the Opportunities (required).</param>
        /// <param name="direction">direction.</param>
        public OpportunitiesSort(ByEnum by = default(ByEnum), SortDirection? direction = default(SortDirection?))
        {
            this.By = by;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpportunitiesSort {\n");
        ...
        {
            return this.Equals(input as OpportunitiesSort);
        }

        /// <summary>
        /// Returns true if OpportunitiesSort instances are equal
        /// </summary>
        /// <param name="input">Instance of OpportunitiesSort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpportunitiesSort input)
        {
            if (input == null)
            {
                return false;
