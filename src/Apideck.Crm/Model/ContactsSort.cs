...
namespace Apideck.Crm.Model
{
    ...
    /// ContactsSort
    /// </summary>
    [DataContract(Name = "ContactsSort")]
    public partial class ContactsSort : IEquatable<ContactsSort>, IValidatableObject
    {
        /// <summary>
        /// The field on which to sort the Contacts
        /// </summary>
        /// <value>The field on which to sort the Contacts</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSort" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactsSort() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSort" /> class.
        /// </summary>
        /// <param name="by">The field on which to sort the Contacts (required).</param>
        /// <param name="direction">direction.</param>
        public ContactsSort(ByEnum by = default(ByEnum), SortDirection? direction = default(SortDirection?))
        {
            this.By = by;
        ...
        {
            return this.Equals(input as ContactsSort);
        }

        /// <summary>
        /// Returns true if ContactsSort instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsSort to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsSort input)
        {
            if (input == null)
            {
                return false;
