...
namespace Apideck.Crm.Model
{
    ...
    public partial class OpportunitiesFilter : IEquatable<OpportunitiesFilter>, IValidatableObject
    {
        ...
        public OpportunitiesFilter(string title = default(string), string status = default(string), decimal monetaryAmount = default(decimal), decimal winProbability = default(decimal))
        {
            this.Title = title;
            this.Status = status;
