...
namespace Apideck.Hris.Model
{
    ...
    /// EmployeeSocialLinks
    /// </summary>
    [DataContract(Name = "Employee_social_links")]
    public partial class EmployeeSocialLinks : IEquatable<EmployeeSocialLinks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeSocialLinks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmployeeSocialLinks() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmployeeSocialLinks" /> class.
        /// </summary>
        ...
        public EmployeeSocialLinks(string id = default(string), string url = default(string), string type = default(string))
        {
            // to ensure "url" is required (not null)
            if (url == null) {
                throw new ArgumentNullException("url is a required property for EmployeeSocialLinks and cannot be null");
            }
            this.Url = url;
            this.Id = id;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmployeeSocialLinks {\n");
        ...
        {
            return this.Equals(input as EmployeeSocialLinks);
        }

        /// <summary>
        /// Returns true if EmployeeSocialLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of EmployeeSocialLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmployeeSocialLinks input)
        {
            if (input == null)
            {
                return false;
