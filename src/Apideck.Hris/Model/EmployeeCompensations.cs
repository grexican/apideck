...
namespace Apideck.Hris.Model
{
    ...
    public partial class EmployeeCompensations : IEquatable<EmployeeCompensations>, IValidatableObject
    {
        ...
        /// <param name="currency">Indicates the associated currency for an amount of money. Values correspond to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217)..</param>
        ...
        public EmployeeCompensations(string rate = default(string), PaymentUnit? paymentUnit = default(PaymentUnit?), CurrencyEnum? currency = default(CurrencyEnum?), FlsaStatusEnum? flsaStatus = default(FlsaStatusEnum?), string effectiveDate = default(string))
        {
            this.Rate = rate;
