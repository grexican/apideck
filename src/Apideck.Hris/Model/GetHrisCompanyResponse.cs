...
namespace Apideck.Hris.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetHrisCompanyResponse")]
    public partial class GetHrisCompanyResponse : IEquatable<GetHrisCompanyResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHrisCompanyResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetHrisCompanyResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetHrisCompanyResponse" /> class.
        /// </summary>
        ...
        public GetHrisCompanyResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), HrisCompany data = default(HrisCompany))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetHrisCompanyResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetHrisCompanyResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetHrisCompanyResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetHrisCompanyResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetHrisCompanyResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetHrisCompanyResponse {\n");
        ...
        {
            return this.Equals(input as GetHrisCompanyResponse);
        }

        /// <summary>
        /// Returns true if GetHrisCompanyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetHrisCompanyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetHrisCompanyResponse input)
        {
            if (input == null)
            {
                return false;
