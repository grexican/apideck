...
namespace Apideck.Hris.Model
{
    ...
    public partial class EmployeeJobs : IEquatable<EmployeeJobs>, IValidatableObject
    {
        ...
        public EmployeeJobs(string title = default(string), string compensationRate = default(string), PaymentUnit? paymentUnit = default(PaymentUnit?), DateTime? hiredAt = default(DateTime?), bool isPrimary = default(bool), Address location = default(Address))
        {
            this.Title = title;
