...
namespace Apideck.FileStorage.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateFolderResponse")]
    public partial class UpdateFolderResponse : IEquatable<UpdateFolderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateFolderResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateFolderResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateFolderResponse" /> class.
        /// </summary>
        ...
        public UpdateFolderResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UnifiedId data = default(UnifiedId))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for UpdateFolderResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for UpdateFolderResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for UpdateFolderResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for UpdateFolderResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for UpdateFolderResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as UpdateFolderResponse);
        }

        /// <summary>
        /// Returns true if UpdateFolderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateFolderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateFolderResponse input)
        {
            if (input == null)
            {
                return false;
