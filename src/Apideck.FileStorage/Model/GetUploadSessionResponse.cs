...
namespace Apideck.FileStorage.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetUploadSessionResponse")]
    public partial class GetUploadSessionResponse : IEquatable<GetUploadSessionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUploadSessionResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetUploadSessionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUploadSessionResponse" /> class.
        /// </summary>
        ...
        public GetUploadSessionResponse(int statusCode = default(int), string status = default(string), string service = default(string), string resource = default(string), string operation = default(string), UploadSession data = default(UploadSession))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetUploadSessionResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "service" is required (not null)
            if (service == null) {
                throw new ArgumentNullException("service is a required property for GetUploadSessionResponse and cannot be null");
            }
            this.Service = service;
            // to ensure "resource" is required (not null)
            if (resource == null) {
                throw new ArgumentNullException("resource is a required property for GetUploadSessionResponse and cannot be null");
            }
            this.Resource = resource;
            // to ensure "operation" is required (not null)
            if (operation == null) {
                throw new ArgumentNullException("operation is a required property for GetUploadSessionResponse and cannot be null");
            }
            this.Operation = operation;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetUploadSessionResponse and cannot be null");
            }
            this.Data = data;
        }
