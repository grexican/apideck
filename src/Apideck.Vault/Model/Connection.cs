...
namespace Apideck.Vault.Model
{
    ...
    public partial class Connection : IEquatable<Connection>, IValidatableObject
    {
        ...
        public Connection(Object settings = default(Object), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), AuthType? authType = default(AuthType?), List<ConnectionConfiguration> configuration = default(List<ConnectionConfiguration>), bool enabled = default(bool), ConnectionState? state = default(ConnectionState?))
        {
