...
namespace Apideck.Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetConsumersResponse")]
    public partial class GetConsumersResponse : IEquatable<GetConsumersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConsumersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConsumersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConsumersResponse" /> class.
        /// </summary>
        ...
        public GetConsumersResponse(int statusCode = default(int), string status = default(string), List<GetConsumersResponseData> data = default(List<GetConsumersResponseData>))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetConsumersResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetConsumersResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        public List<GetConsumersResponseData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetConsumersResponse {\n");
        ...
        {
            return this.Equals(input as GetConsumersResponse);
        }

        /// <summary>
        /// Returns true if GetConsumersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetConsumersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetConsumersResponse input)
        {
            if (input == null)
            {
                return false;
