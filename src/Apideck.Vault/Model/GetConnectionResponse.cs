...
namespace Apideck.Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetConnectionResponse")]
    public partial class GetConnectionResponse : IEquatable<GetConnectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConnectionResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConnectionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConnectionResponse" /> class.
        /// </summary>
        ...
        public GetConnectionResponse(int statusCode = default(int), string status = default(string), Connection data = default(Connection))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for GetConnectionResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for GetConnectionResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as GetConnectionResponse);
        }

        /// <summary>
        /// Returns true if GetConnectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetConnectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetConnectionResponse input)
        {
            if (input == null)
            {
                return false;
