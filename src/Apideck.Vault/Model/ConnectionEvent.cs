...
namespace Apideck.Vault.Model
{
    ...
    public partial class ConnectionEvent : IEquatable<ConnectionEvent>, IValidatableObject
    {
        ...
        public ConnectionEvent(string eventId = default(string), string serviceId = default(string), string entityId = default(string), string entityType = default(string), ConsumerConnection entity = default(ConsumerConnection), VaultEventType? eventType = default(VaultEventType?), decimal executionAttempt = default(decimal), string occurredAt = default(string))
        {
