...
namespace Apideck.Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateConnectionResponse")]
    public partial class UpdateConnectionResponse : IEquatable<UpdateConnectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConnectionResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateConnectionResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateConnectionResponse" /> class.
        /// </summary>
        ...
        public UpdateConnectionResponse(int statusCode = default(int), string status = default(string), Connection data = default(Connection))
        {
            this.StatusCode = statusCode;
            // to ensure "status" is required (not null)
            if (status == null) {
                throw new ArgumentNullException("status is a required property for UpdateConnectionResponse and cannot be null");
            }
            this.Status = status;
            // to ensure "data" is required (not null)
            if (data == null) {
                throw new ArgumentNullException("data is a required property for UpdateConnectionResponse and cannot be null");
            }
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as UpdateConnectionResponse);
        }

        /// <summary>
        /// Returns true if UpdateConnectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateConnectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateConnectionResponse input)
        {
            if (input == null)
            {
                return false;
