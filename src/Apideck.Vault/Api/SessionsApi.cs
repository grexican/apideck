...
namespace Apideck.Vault.Api
{
    ...
    public interface ISessionsApiSync : IApiAccessor
    {
        ...
        CreateSessionResponse SessionsCreate(string xApideckConsumerId, string xApideckAppId, Session session = default(Session));
        ...
        ApiResponse<CreateSessionResponse> SessionsCreateWithHttpInfo(string xApideckConsumerId, string xApideckAppId, Session session = default(Session));
    ...
    public interface ISessionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreateSessionResponse> SessionsCreateAsync(string xApideckConsumerId, string xApideckAppId, Session session = default(Session), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreateSessionResponse>> SessionsCreateWithHttpInfoAsync(string xApideckConsumerId, string xApideckAppId, Session session = default(Session), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SessionsApi : ISessionsApi
    {
        ...
        /// <returns></returns>
        public SessionsApi(Apideck.Vault.Client.Configuration configuration)
        {
        ...
        public SessionsApi(Apideck.Vault.Client.ISynchronousClient client, Apideck.Vault.Client.IAsynchronousClient asyncClient, Apideck.Vault.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="session">Additional redirect uri and/or consumer metadata (optional)</param>
        /// <returns>CreateSessionResponse</returns>
        public CreateSessionResponse SessionsCreate(string xApideckConsumerId, string xApideckAppId, Session session = default(Session))
        {
            Apideck.Vault.Client.ApiResponse<CreateSessionResponse> localVarResponse = SessionsCreateWithHttpInfo(xApideckConsumerId, xApideckAppId, session);
        ...
        /// <param name="session">Additional redirect uri and/or consumer metadata (optional)</param>
        /// <returns>ApiResponse of CreateSessionResponse</returns>
        public Apideck.Vault.Client.ApiResponse<CreateSessionResponse> SessionsCreateWithHttpInfo(string xApideckConsumerId, string xApideckAppId, Session session = default(Session))
        {
            // verify the required parameter 'xApideckConsumerId' is set
            if (xApideckConsumerId == null)
            {
                throw new Apideck.Vault.Client.ApiException(400, "Missing required parameter 'xApideckConsumerId' when calling SessionsApi->SessionsCreate");
            }

            // verify the required parameter 'xApideckAppId' is set
            if (xApideckAppId == null)
            {
                throw new Apideck.Vault.Client.ApiException(400, "Missing required parameter 'xApideckAppId' when calling SessionsApi->SessionsCreate");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreateSessionResponse</returns>
        public async System.Threading.Tasks.Task<CreateSessionResponse> SessionsCreateAsync(string xApideckConsumerId, string xApideckAppId, Session session = default(Session), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Apideck.Vault.Client.ApiResponse<CreateSessionResponse> localVarResponse = await SessionsCreateWithHttpInfoAsync(xApideckConsumerId, xApideckAppId, session, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateSessionResponse)</returns>
        public async System.Threading.Tasks.Task<Apideck.Vault.Client.ApiResponse<CreateSessionResponse>> SessionsCreateWithHttpInfoAsync(string xApideckConsumerId, string xApideckAppId, Session session = default(Session), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xApideckConsumerId' is set
            if (xApideckConsumerId == null)
            {
