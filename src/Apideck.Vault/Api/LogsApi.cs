...
namespace Apideck.Vault.Api
{
    ...
    public interface ILogsApiSync : IApiAccessor
    {
        ...
        GetLogsResponse LogsAll(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?));
        ...
        ApiResponse<GetLogsResponse> LogsAllWithHttpInfo(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?));
    ...
    public interface ILogsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetLogsResponse> LogsAllAsync(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetLogsResponse>> LogsAllWithHttpInfoAsync(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class LogsApi : ILogsApi
    {
        ...
        /// <returns></returns>
        public LogsApi(Apideck.Vault.Client.Configuration configuration)
        {
        ...
        public LogsApi(Apideck.Vault.Client.ISynchronousClient client, Apideck.Vault.Client.IAsynchronousClient asyncClient, Apideck.Vault.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="limit">Number of records to return (optional, default to 20)</param>
        /// <returns>GetLogsResponse</returns>
        public GetLogsResponse LogsAll(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?))
        {
            Apideck.Vault.Client.ApiResponse<GetLogsResponse> localVarResponse = LogsAllWithHttpInfo(xApideckAppId, xApideckConsumerId, filter, cursor, limit);
        ...
        /// <param name="limit">Number of records to return (optional, default to 20)</param>
        /// <returns>ApiResponse of GetLogsResponse</returns>
        public Apideck.Vault.Client.ApiResponse<GetLogsResponse> LogsAllWithHttpInfo(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?))
        {
            // verify the required parameter 'xApideckAppId' is set
            if (xApideckAppId == null)
            {
                throw new Apideck.Vault.Client.ApiException(400, "Missing required parameter 'xApideckAppId' when calling LogsApi->LogsAll");
            }

            // verify the required parameter 'xApideckConsumerId' is set
            if (xApideckConsumerId == null)
            {
                throw new Apideck.Vault.Client.ApiException(400, "Missing required parameter 'xApideckConsumerId' when calling LogsApi->LogsAll");
            }
            ...
            if (filter != null)
            {
                ...
                {
                    localVarRequestOptions.QueryParameters.Add(Apideck.Vault.Client.ClientUtils.ParameterToMultiMap("", "filter[connector_id]", filter.ConnectorId));
                }
                if (filter.StatusCode != null)
                {
                    localVarRequestOptions.QueryParameters.Add(Apideck.Vault.Client.ClientUtils.ParameterToMultiMap("", "filter[status_code]", filter.StatusCode));
                }
                if (filter.ExcludeUnifiedApis != null)
                {
                    localVarRequestOptions.QueryParameters.Add(Apideck.Vault.Client.ClientUtils.ParameterToMultiMap("", "filter[exclude_unified_apis]", filter.ExcludeUnifiedApis));
                }
            }
            if (cursor != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetLogsResponse</returns>
        public async System.Threading.Tasks.Task<GetLogsResponse> LogsAllAsync(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Apideck.Vault.Client.ApiResponse<GetLogsResponse> localVarResponse = await LogsAllWithHttpInfoAsync(xApideckAppId, xApideckConsumerId, filter, cursor, limit, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetLogsResponse)</returns>
        public async System.Threading.Tasks.Task<Apideck.Vault.Client.ApiResponse<GetLogsResponse>> LogsAllWithHttpInfoAsync(string xApideckAppId, string xApideckConsumerId, LogsFilter filter = default(LogsFilter), string cursor = default(string), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xApideckAppId' is set
            if (xApideckAppId == null)
            {
            ...
            if (filter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Apideck.Vault.Client.ClientUtils.ParameterToMultiMap("", "filter", filter));
            }
            if (cursor != null)
            {
                localVarRequestOptions.QueryParameters.Add(Apideck.Vault.Client.ClientUtils.ParameterToMultiMap("", "cursor", cursor));
