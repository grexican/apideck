# Apideck.FileStorage - the C# library for the File storage API

Welcome to the file-storage.

You can use this API to access all file-storage endpoints.
...
## Documentation for Models
 ...
 - [Model.CopyFolderRequest](docs/CopyFolderRequest.md)
 - [Model.CreateFileRequest](docs/CreateFileRequest.md)
 - [Model.CreateFileResponse](docs/CreateFileResponse.md)
 - [Model.CreateFolderRequest](docs/CreateFolderRequest.md)
 - [Model.CreateFolderResponse](docs/CreateFolderResponse.md)
 - [Model.CreateSharedLinkResponse](docs/CreateSharedLinkResponse.md)
 - [Model.CreateUploadSessionRequest](docs/CreateUploadSessionRequest.md)
 - [Model.CreateUploadSessionResponse](docs/CreateUploadSessionResponse.md)
 - [Model.DeleteFileResponse](docs/DeleteFileResponse.md)
 - [Model.DeleteFolderResponse](docs/DeleteFolderResponse.md)
 - [Model.DeleteSharedLinkResponse](docs/DeleteSharedLinkResponse.md)
 - [Model.DeleteUploadSessionResponse](docs/DeleteUploadSessionResponse.md)
 - [Model.FileType](docs/FileType.md)
 - [Model.FilesFilter](docs/FilesFilter.md)
 - [Model.FilesSearch](docs/FilesSearch.md)
 - [Model.FilesSort](docs/FilesSort.md)
 - [Model.Folder](docs/Folder.md)
 - [Model.GetFileResponse](docs/GetFileResponse.md)
 - [Model.GetFilesResponse](docs/GetFilesResponse.md)
 - [Model.GetFolderResponse](docs/GetFolderResponse.md)
 - [Model.GetFoldersResponse](docs/GetFoldersResponse.md)
 - [Model.GetSharedLinkResponse](docs/GetSharedLinkResponse.md)
 - [Model.GetSharedLinksResponse](docs/GetSharedLinksResponse.md)
 - [Model.GetUploadSessionResponse](docs/GetUploadSessionResponse.md)
 - [Model.LinkedFolder](docs/LinkedFolder.md)
 ...
 - [Model.SharedLink](docs/SharedLink.md)
 - [Model.SharedLinkTarget](docs/SharedLinkTarget.md)
 ...
 - [Model.UnifiedFile](docs/UnifiedFile.md)
 - [Model.UnifiedId](docs/UnifiedId.md)
 - [Model.UnprocessableResponse](docs/UnprocessableResponse.md)
 - [Model.UpdateFileResponse](docs/UpdateFileResponse.md)
 - [Model.UpdateFolderRequest](docs/UpdateFolderRequest.md)
 - [Model.UpdateFolderResponse](docs/UpdateFolderResponse.md)
 - [Model.UpdateSharedLinkResponse](docs/UpdateSharedLinkResponse.md)
 - [Model.UpdateUploadSessionResponse](docs/UpdateUploadSessionResponse.md)
