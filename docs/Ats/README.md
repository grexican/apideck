# Apideck.Ats - the C# library for the ats

Welcome to the ats.

You can use this API to access all ats endpoints.
...
## Documentation for Models
 ...
 - [Model.CreateApplicantResponse](docs/CreateApplicantResponse.md)
 - [Model.Currency](docs/Currency.md)
 - [Model.CustomField](docs/CustomField.md)
 - [Model.Email](docs/Email.md)
 - [Model.GetApplicantResponse](docs/GetApplicantResponse.md)
 - [Model.GetApplicantsResponse](docs/GetApplicantsResponse.md)
 - [Model.GetJobResponse](docs/GetJobResponse.md)
 - [Model.GetJobsResponse](docs/GetJobsResponse.md)
 - [Model.Job](docs/Job.md)
 - [Model.JobStatus](docs/JobStatus.md)
 - [Model.JobsFilter](docs/JobsFilter.md)
