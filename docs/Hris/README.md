# Apideck.Hris - the C# library for the hris
...
## Documentation for Models
 ...
 - [Model.CreateEmployeeResponse](docs/CreateEmployeeResponse.md)
 - [Model.CreateHrisCompanyResponse](docs/CreateHrisCompanyResponse.md)
 - [Model.CustomField](docs/CustomField.md)
 - [Model.DeleteEmployeeResponse](docs/DeleteEmployeeResponse.md)
 - [Model.DeleteHrisCompanyResponse](docs/DeleteHrisCompanyResponse.md)
 - [Model.Email](docs/Email.md)
 - [Model.Employee](docs/Employee.md)
 - [Model.EmployeeCompensations](docs/EmployeeCompensations.md)
 - [Model.EmployeeEmploymentRole](docs/EmployeeEmploymentRole.md)
 - [Model.EmployeeJobs](docs/EmployeeJobs.md)
 - [Model.EmployeeManager](docs/EmployeeManager.md)
 - [Model.EmployeeSocialLinks](docs/EmployeeSocialLinks.md)
 - [Model.EmployeeTeam](docs/EmployeeTeam.md)
 - [Model.Gender](docs/Gender.md)
 - [Model.GetEmployeeResponse](docs/GetEmployeeResponse.md)
 - [Model.GetEmployeesResponse](docs/GetEmployeesResponse.md)
 - [Model.GetHrisCompaniesResponse](docs/GetHrisCompaniesResponse.md)
 - [Model.GetHrisCompanyResponse](docs/GetHrisCompanyResponse.md)
 - [Model.HrisCompany](docs/HrisCompany.md)
 ...
 - [Model.PaymentUnit](docs/PaymentUnit.md)
 ...
 - [Model.UpdateEmployeeResponse](docs/UpdateEmployeeResponse.md)
 - [Model.UpdateHrisCompanyResponse](docs/UpdateHrisCompanyResponse.md)
