# Apideck.Sms - the C# library for the sms

Welcome to the sms.

You can use this API to access all sms endpoints.
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MessagesApi.MessagesAdd: " + e.Message );
...
## Documentation for Models
 ...
 - [Model.CreateMessageResponse](docs/CreateMessageResponse.md)
 ...
 - [Model.GetMessageResponse](docs/GetMessageResponse.md)
 ...
 - [Model.UpdateMessageResponse](docs/UpdateMessageResponse.md)
