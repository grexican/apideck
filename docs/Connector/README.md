# Apideck.Connector - the C# library for the Connector API

Welcome to the Connector API.

You can use this API to access all connector endpoints.
...
## Documentation for Models
 ...
 - [Model.ApiResource](docs/ApiResource.md)
 - [Model.ApiResourceCoverage](docs/ApiResourceCoverage.md)
 - [Model.ApiResourceCoverageCoverage](docs/ApiResourceCoverageCoverage.md)
 - [Model.ApiResourceCoverageSupportedFields](docs/ApiResourceCoverageSupportedFields.md)
 - [Model.ApiResourceLinkedResources](docs/ApiResourceLinkedResources.md)
 - [Model.ApiResources](docs/ApiResources.md)
 - [Model.ApiStatus](docs/ApiStatus.md)
 - [Model.ApisFilter](docs/ApisFilter.md)
 - [Model.Connector](docs/Connector.md)
 - [Model.ConnectorOauthScopes](docs/ConnectorOauthScopes.md)
 - [Model.ConnectorResource](docs/ConnectorResource.md)
 - [Model.ConnectorSetting](docs/ConnectorSetting.md)
 - [Model.ConnectorStatus](docs/ConnectorStatus.md)
 - [Model.ConnectorSupportedEvents](docs/ConnectorSupportedEvents.md)
 - [Model.ConnectorSupportedResources](docs/ConnectorSupportedResources.md)
 - [Model.ConnectorUnifiedApis](docs/ConnectorUnifiedApis.md)
 - [Model.ConnectorsFilter](docs/ConnectorsFilter.md)
 - [Model.GetApiResourceCoverageResponse](docs/GetApiResourceCoverageResponse.md)
 - [Model.GetApiResourceResponse](docs/GetApiResourceResponse.md)
 - [Model.GetApiResponse](docs/GetApiResponse.md)
 - [Model.GetApisResponse](docs/GetApisResponse.md)
 - [Model.GetConnectorResourceResponse](docs/GetConnectorResourceResponse.md)
 - [Model.GetConnectorResponse](docs/GetConnectorResponse.md)
 - [Model.GetConnectorsResponse](docs/GetConnectorsResponse.md)
