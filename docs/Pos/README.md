# Apideck.Pos - the C# library for the pos

Welcome to the pos.

You can use this API to access all pos endpoints.
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling OrdersApi.OrdersAdd: " + e.Message );
...
## Documentation for Models
 ...
 - [Model.DeleteOrderResponse](docs/DeleteOrderResponse.md)
 ...
 - [Model.OrderMerchant](docs/OrderMerchant.md)
