...
<a name="usersadd"></a>
# **UsersAdd**
> CreateUserResponse UsersAdd (string xApideckConsumerId, string xApideckAppId, User user, bool? raw = null, string xApideckServiceId = null)
...
<a name="usersall"></a>
# **UsersAll**
> GetUsersResponse UsersAll (string xApideckConsumerId, string xApideckAppId, bool? raw = null, string xApideckServiceId = null, string cursor = null, int? limit = null)
...
namespace Example
{
    public class UsersAllExample
    {
        public static void Main()
        {
            ...
            {
                // List users
                GetUsersResponse result = apiInstance.UsersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling UsersApi.UsersAll: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **UsersDelete**
> DeleteUserResponse UsersDelete (string id, string xApideckConsumerId, string xApideckAppId, string xApideckServiceId = null, bool? raw = null)
...
<a name="usersone"></a>
# **UsersOne**
> GetUserResponse UsersOne (string id, string xApideckConsumerId, string xApideckAppId, string xApideckServiceId = null, bool? raw = null)
...
namespace Example
{
    public class UsersOneExample
    {
        public static void Main()
        {
            ...
            {
                // Get user
                GetUserResponse result = apiInstance.UsersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling UsersApi.UsersOne: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **UsersUpdate**
> UpdateUserResponse UsersUpdate (string id, string xApideckConsumerId, string xApideckAppId, User user, string xApideckServiceId = null, bool? raw = null)
