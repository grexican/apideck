# Apideck.CustomerSupport - the C# library for the Customer Support

Welcome to the Customer Support.

You can use this API to access all Customer Support endpoints.
...
```csharp
using Apideck.CustomerSupport.Api;
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            var customerSupportCustomer = new CustomerSupportCustomer(); // CustomerSupportCustomer | 
...
## Documentation for Models
 ...
 - [Model.CreateCustomerSupportCustomerResponse](docs/CreateCustomerSupportCustomerResponse.md)
 - [Model.Currency](docs/Currency.md)
 - [Model.CustomField](docs/CustomField.md)
 - [Model.CustomerSupportCustomer](docs/CustomerSupportCustomer.md)
 - [Model.DeleteCustomerSupportCustomerResponse](docs/DeleteCustomerSupportCustomerResponse.md)
 - [Model.Email](docs/Email.md)
 - [Model.GetCustomerSupportCustomerResponse](docs/GetCustomerSupportCustomerResponse.md)
 - [Model.GetCustomerSupportCustomersResponse](docs/GetCustomerSupportCustomersResponse.md)
 ...
 - [Model.UpdateCustomerSupportCustomerResponse](docs/UpdateCustomerSupportCustomerResponse.md)
